...
## 4. Usage
_Note: LiveEdit will wrap your text inside the element (specified below, default 'span'), which needs to be positioned relative and must be block or inline-block. So, make sure it will not break your design. You can customize the element's tag name._
